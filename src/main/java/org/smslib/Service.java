...
public class Service {
     ...
     * @throws GatewayException You tried to add a gateway while the Service is started.
     ...
     * @throws GatewayException You tried to remove a gateway while the Service is started.
     ...
     *
     * @throws SMSLibException      No Gateways are defined.
     ...
     *
     * @param startAllGateways True if all gateways should be started, False if some gateways
     *                         are allowed to fail.
     * @throws SMSLibException      No Gateways are defined.
     * @throws TimeoutException     The gateway did not respond in a timely manner.
     * @throws GatewayException     A Gateway error occurred.
     ...
     *
     * @param msgList  A (probably empty) list that will be populated with Inbound
     *                 messages read.
     * @param msgClass Filtering: Class of messages that need to be read.
     ...
     *                  messages read.
     * @param msgClass  Filtering: Class of messages that need to be read.
     * @param gatewayId The identifier of the gateway from which to read messages.
     * @return The number of messages read.
     * @throws TimeoutException     The gateway did not respond in a timely manner.
     * @throws GatewayException     A Gateway error occurred.
     * @throws IOException          An IO error occurred.
     ...
     *                 messages read.
     * @param msgClass Filtering: Class of messages that need to be read.
     * @param gateway  The gateway object from which to read messages.
     * @return The number of messages read.
     * @throws TimeoutException     The gateway did not respond in a timely manner.
     * @throws GatewayException     A Gateway error occurred.
     * @throws IOException          An IO error occurred.
     ...
     *
     * @param gatewayId The Gateway ID of the gateway to read from.
     * @param memLoc    The memory location string.
     * @param memIndex  The memory index.
     ...
     * operation).
     *
     * @param msg An OutboundMessage object.
     ...
     *
     * @param msg       An OutboundMessage object.
     * @param gatewayId The id of the gateway that will be used for sending.
     * @return True if the message is sent.
     * @throws TimeoutException     The gateway did not respond in a timely manner.
     * @throws GatewayException     A Gateway error occurred.
     * @throws IOException          An IO error occurred.
     ...
     *
     * @param msgList A list of OutboundMessage objects.
     ...
     *
     * @param msg       A OutboundMessage object.
     * @param gatewayId The id of the gateway that will be used for sending.
     * @return True if the message is accepted in the Queue.
     * @see #queueMessage(OutboundMessage)
     */
     ...
     *
     * @param msgList   A list of OutboundMessage objects.
     * @param gatewayId The id of the gateway to be used for sending.
     * @return The number of messages accepted in the Queue.
     * @see #queueMessage(OutboundMessage)
     */
     ...
     * @param at  The date/time that the message should be sent at.
     * @return True if the message is accepted in the Queue.
     ...
     *
     * @param msg         The message to be sent.
     * @param delayMillis The delay (ms) that the message should be sent after.
     * @return True if the message is accepted in the Queue.
     * @see #queueMessageAt(OutboundMessage, Date)
     * @see #queueMessage(OutboundMessage)
     */
     ...
     * queueMessage() calls.
     *
     * @param msg The outbound message to be removed.
     ...
     * gateways.
     *
     * @param msg The message to be deleted. It must be a valid InboundMessage
     ...
     *
     * @param phonebook An already instantiated, empty Phonebook class.
     * @param gatewayId The gateway id for which the phonebook should be loaded
     ...
     *
     * @param gatewayId The id of the gateway to query.
     ...
     * Returns the total number of messages received by the specified gateway.
     *
     * @param gateway The AGateway object to query.
     * @return The number of received messages or -1 on error.
     */
     ...
     *
     * @param gatewayId The ID of gateway to find.
     ...
     *
     * @param loadBalancer The Load Balancer that will take effect.
     * @see LoadBalancer
     */
     ...
     * Sets a new Router.
     *
     * @param router The Router that will take effect.
     * @see Router
     */
     ...
     *
     * @param inboundNotification The method to be called.
     ...
     *
     * @param groupName The group name to be expanded.
     ...
     *
     * @param groupName The group to which the number is to be added.
     ...
     *
     * @param groupName The group from which the number is to be removed.
     ...
     *
     * @param groupName The group in which the number is to be searched.
