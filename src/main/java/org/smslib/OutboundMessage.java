...
public class OutboundMessage extends Message {
     ...
     *
     * @param myRecipient The recipient of the message.
     ...
     *
     * @param flashSms True for a flash sms.
     */
     ...
     *
     * @param myStatusReport The status report request status.
     */
     ...
     *
     * @param myValidityPeriod The message validity period in hours.
     ...
     *
     * @param myFrom The custom originator string.
     * @see #getFrom()
     */
     ...
     *
     * @param myFailureCause Cause of failure
     */
     ...
     *
     * @param myPriority The new priority.
     */
