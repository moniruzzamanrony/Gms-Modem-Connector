...
public abstract class Message implements Serializable {
     ...
     *
     * @param myEncoding The message encoding.
     * @see #getEncoding()
     * @see MessageEncodings
     */
     ...
     * The default is (-1).
     *
     * @param myDstPort The destination port.
     * @see #setDstPort(int)
     * @see #setSrcPort(int)
     * @see #getSrcPort()
     */
     ...
     * The default is (-1).
     *
     * @param mySrcPort The source port.
     * @see #setDstPort(int)
     * @see #setSrcPort(int)
     * @see #getSrcPort()
     */
