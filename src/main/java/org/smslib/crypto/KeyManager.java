...
public class KeyManager {
     ...
     *
     * @param mobileNumber The mobile number which will be associated with the encryption
     *                     key.
     ...
     *
     * @param mobileNumber The mobile number which will be removed from the key
     *                     associations.
     ...
     *
     * @param mobileNumber The mobile number to look for.
     ...
     *
     * @param mobileNumber The mobile number which the message will be send to / received
     *                     from.
