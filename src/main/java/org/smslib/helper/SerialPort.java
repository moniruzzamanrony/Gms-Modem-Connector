...
public class SerialPort {
     ...
     *
     * @param lsnr The SerialPortEventListener object whose serialEvent method
     *             will be called with a SerialEvent describing the event.
     * @throws java.util.TooManyListenersException (Wrapped as RuntimeException) If an initial attempt to attach
     ...
     * behaviour.
     *
     * @param i when this many bytes are in the input buffer, return
     ...
     * </p>
     *
     * @param rcvTimeout when this many milliseconds have elapsed, return immediately
     ...
     * size.
     *
     * @param serial_buffer_size input buffer size currently in use
     */
     ...
     *
     * @param serial_buffer_size size of the output buffer
     */
     ...
     *
     * @param baudrate If the baudrate passed in by the application is unsupported by
