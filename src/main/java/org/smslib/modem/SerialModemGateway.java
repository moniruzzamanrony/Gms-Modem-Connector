...
public class SerialModemGateway extends ModemGateway {
     ...
     * @param comPort      The comm port to which this modem is connected. For example,
     *                     COM1 or /dev/ttyS1.
     * @param baudRate     The baud rate of the serial connection.
     * @param manufacturer The manufacturer, for example "Nokia".
     * @param model        The model, for example "6130"
     */
