...
public class CNMIDetector {
     ...
     *
     * @param cnmi The AT+CNMI=? response of a GSM device
     */
     ...
     *
     * @param range The raw range. Surrounding braces are deleted
     */
     ...
     * in searchedOptions)
     *
     * @param availableOptions array to search in
     * @param searchedOptions  elements of patterns
