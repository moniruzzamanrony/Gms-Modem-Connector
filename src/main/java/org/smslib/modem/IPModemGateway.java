...
public class IPModemGateway extends ModemGateway {
     ...
     *
     * @param id           Your own ID for addressing this gateway.
     * @param ipName       The address to which the modem is listening, i.e. 10.0.0.200.
     * @param ipPort       The port to which the modem is listening, i.e. 8000
     * @param manufacturer The manufacturer, for example "Multitech".
     * @param model        The model, for example "GSX"
     */
