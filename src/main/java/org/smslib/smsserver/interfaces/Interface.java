...
public class Interface<T> {
     ...
     * functionality</b>.
     *
     * @param gtwId    The Id of the gateway which received the call.
     ...
     * functionality</b>.
     *
     * @param msgList A message list of all received messages.
     * @throws Exception
     */
     ...
     * functionality</b>.
     *
     * @throws Exception An exception thrown will stop SMSServer from starting its
     *                   processing.
     */
