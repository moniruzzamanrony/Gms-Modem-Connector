...
public class KannelHttp extends AGateway {
    ...
    public void create() throws Exception {
        ...
        KannelHTTPGateway gateway = new KannelHTTPGateway(getGatewayId(), properties.getProperty(propName + "url"), properties.getProperty(propName + "username"), properties.getProperty(propName + "password"));
        setGateway(gateway);
