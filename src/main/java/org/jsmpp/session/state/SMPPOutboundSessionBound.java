...
/**
 * This class is general bound state implementation of {@link SMPPOutboundSessionState}.
 *
 * @author pmoerenhout
 * @version 1.0
 * @since 2.3
 */
abstract class SMPPOutboundSessionBound extends AbstractGenericSMPPSessionBound implements SMPPOutboundSessionState {
